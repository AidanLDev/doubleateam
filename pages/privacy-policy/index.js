    ...
    <Box className={styles.privacyPolicyContainer}>
      ...
      <Layout>
        ...
        >
          ...
          <Text>
            Double A Team operate the https://www.doubleateam.co.uk website,
            which provides a blogging or artical service where we post regarding
            various topics we think our readers will find either useful or
            interesting.
          </Text>
          <Text>
            This page is used to inform website visitors regarding our policies
            with the collection, use, and disclosure of Personal Information if
            anyone decided to use our Service, the Double A Team Name website.
          </Text>
          <Text>
