...
const EnglishBlog = (
  ...
  >
    ...
    <Text>
      ...
      started this process, we had no idea what the type of visa we wanted was.
      There are also fiance/fiancee visas or spouse visa types, with a
      fiance/spouse visa you can stay in the UK for up to 6 months, however, one
      of the requirements is that you must get married within this time period.
      If you do so, you can then apply to extend your stay and obtain a family
      visa (this can be a viable route if you and your partner both want to
      marry in the UK, however, it's going to be a pricy one as you'll have to
      pay for both the fiance/spouse visa application then the family visa.
      We'll get onto family visa pricing further down).
    </Text>
    ...
    <Text>
      ...
      The majority of questions are self-explanatory. A few stand-out ones that
    ...
    />
    <Text>
      The application is pretty lengthy but most of the questions you just need
      to input data about yourself so they’re not too difficult.
    </Text>
    <Text>
      Once you’ve paid and submitted your application, you will have to book an
      appointment to provide Biometric data. Once this appointment has been
    ...
    <Text>
      ...
      and created an appointment at your biometric centre of choice. Once you've
      booked an appointment, you can start submitting documents online from when
      you book your appointment until 24 hours before your appointment. There
      are add-ons you can pay for such as document scanning assistance etc.
    </Text>
    <Text>
      The actual documents checklist is relatively short. However, if you want a
      really solid application (which we all do, especially considering how
    ...
    <Text>
      The TB test and Secure English language test are two bits of documents you
      may not even need to gather. However, if you do, you will need to study
      for the English test and book an appointment for the TB test which could
      take some time, so let us get those out the way first.
    </Text>
    ...
    />
    <Text>
      If you don't meet any of the above conditions, you will need to study for
      your test, the one we prepared for and passed (hurray) was the IELTS.{' '}
    ...
    <Text>
      Here's a quickfire round regarding general documents you'll need to gather
    ...
    <Text>
      The threshold to meet the UKVI financial requirements is an annual salary
      of at least £18,600. However, if you don't meet this requirement and have
      a substantial amount in savings, £60,000+, as long as you can prove these
      savings are accessible to you, you should be good.
    </Text>
    <Text>
      The documents you should gather to prove your finances and that you've got
      permission to stay wherever you said you would be staying in your visa
      application.
    </Text>
    <StyledUL
      items={[
    ...
    />
    <Text>
      Phew! That was a lot wasn't it! For personalised support on gathering the
      documents alone, we couldn't recommend i-vars, the visa counsellor,
      enough. They were superstars and answered all 1,000 questions we had for
      them. Now all that’s left is the waiting game. Usually, the visa will take
      less than 3 months to process, however with the pandemic there’s a bit of
      a backlog and it could take up to 4 months or so. The{' '}
    ...
    <Text>
      ...
      VSFGlobal or by directly sending the documents to an address in Birmingham
      England. Although they charged £100 to send the docs. It’s reassuring to
      know that if you did forget to submit a particular doc at the time of your
      application, it’s not your final chance to give UKVI everything they need
      to make your application succeed.
    </Text>
    <Heading size='md'>Visa Duration</Heading>
    <Text>
      With a UK family visa, you can initially stay in the UK for 2 years and 9
      months. After this you'll be able to apply to extend your stay for another
      2 years and 6 months. After you have lived in the UK for 5 years
    ...
    <Text>
      All the best of luck to you and we wish you and your partner a happy life
      together{' '}
    </Text>
  </BlogLayout>
);
...
const IndonesianBlog = (
  ...
  >
    ...
    <Text>
      Visa keluarga, di masa lalu ada beberapa visa lagi seperti visa orang tua
      atau bahkan visa anak, namun sekarang ini semua termasuk dalam kategori
      visa keluarga. Hanya untuk menjernihkan kebingungan, ketika kita pertama
      kali memulai proses ini, kami tidak tahu jenis visa apa yang kami
      inginkan. Ada juga jenis visa tunangan/tunangan atau visa pasangan, dengan
      a visa tunangan/pasangan Anda dapat tinggal di Inggris hingga 6 bulan,
      namun, satu salah satu syaratnya adalah kamu harus menikah dalam jangka
      waktu tersebut. Jika Anda melakukannya, Anda dapat mengajukan permohonan
      untuk memperpanjang masa tinggal Anda dan mendapatkan keluarga visa (ini
      bisa menjadi rute yang layak jika Anda dan pasangan Anda ingin menikah di
      Inggris, bagaimanapun, itu akan menjadi pernikahan yang mahal karena Anda
      harus membayar aplikasi visa tunangan/pasangan kemudian visa keluarga.
      Kami akan membahas harga visa keluarga lebih jauh).
    </Text>
    <Heading size='md'>Pengeluaran</Heading>
    <Text>
      Visa keluarga itu cukup mahal. Harganya £1.682 untuk aplikasi dan tambahan
      £2.047 untuk IHS (gelombang asuransi kesehatan) a pembayaran yang
      diperlukan sebagai bagian dari aplikasi. Kami harus mendapatkannya benar,
      untuk menjalani hidup kita bersama dan membangun masa depan kita.
    </Text>
    <Heading size='md'>Konsultan Visa</Heading>
    <Text>
      Itu sebabnya kami menyewa konsultan visa dari{' '}
      <SimpleLink link='https://www.i-vars.com/'>I-vars</SimpleLink>. Milik
      mereka layanan sangat membantu, mereka mulai dengan panggilan awal, pergi
      melalui proses itu sendiri dan mereka memahami Anda dan Anda situasi
      sehingga mereka dapat mengetahui cara terbaik untuk membantu. Setelah
      mendaftar, mereka mengirim bungkus dengan semua informasi tentang proses
      aplikasi visa dan dokumen yang diperlukan untuk mendapatkan persetujuan
      yang kita semua butuhkan. Mereka akan meninjau apa pun dokumen dan
    ...
    <Text>
      ...
      Sebagian besar pertanyaan cukup jelas. Beberapa yang menonjol itu bisa
      dilakukan dengan beberapa klarifikasi lebih lanjut:
    </Text>
    <StyledUL
      items={[
        { text: 'When did you first meet?' },
    ...
    />
    <Text>
      Aplikasi ini cukup panjang tetapi sebagian besar pertanyaan yang Anda
      butuhkan untuk memasukkan data tentang diri Anda agar tidak terlalu sulit.
    </Text>
    <Text>
      Setelah Anda membayar dan mengirimkan aplikasi Anda, Anda harus memesan
      dan janji untuk memberikan data Biometrik. Setelah janji ini telah
      dipesan, Anda dapat mengirimkan bukti pendukung Anda ke pusat visa.
    </Text>
    <Heading size='md'>Dokumen pendukung</Heading>
    <Text>
      Pertama, ada baiknya mengetahui apa yang Anda coba buktikan dengan
      dokumen;
    </Text>
    <StyledUL
      items={[
    ...
    />
    <Text>
      Dokumen dapat dikirimkan setelah Anda menyelesaikan aplikasi online dan
      membuat janji temu di pusat biometrik pilihan Anda. Setelah Anda memesan
      janji temu, Anda dapat mulai mengirimkan dokumen secara online dari kapan
      Anda memesan janji Anda sampai 24 jam sebelum janji Anda. Di sana adalah
      add-on yang dapat Anda bayar seperti bantuan pemindaian dokumen, dll.
    </Text>
    <Text>
      Daftar periksa dokumen sebenarnya relatif singkat. Namun, jika Anda ingin
      aplikasi yang sangat solid (yang kita semua lakukan, terutama mengingat
      caranya pricy itu bahkan berlaku), maka Anda akan ingin mengirimkan banyak
      dokumen pendukung untuk membuatnya tidak diragukan lagi bahwa Anda
      memenuhi kriteria disebutkan di atas.
    </Text>
    <Heading size='sm'>Dokumen Bersyarat</Heading>
    <Text>
      Tes TB dan tes bahasa Inggris Aman adalah dua bit dokumen yang Anda bahkan
      mungkin tidak perlu berkumpul. Namun, jika Anda melakukannya, Anda harus
      belajar untuk tes bahasa Inggris dan membuat janji untuk tes TB yang bisa
      luangkan waktu, jadi mari kita selesaikan dulu.
    </Text>
    <Heading size='xs'>Tes TB</Heading>
    <Text>
      Untuk mengetahui apakah negara Anda terdaftar membutuhkan tes TB,{' '}
      <SimpleLink link='https://www.gov.uk/tb-test-visa/countries-where-you-need-a-tb-test-to-enter-the-uk'>
    ...
    <Text>
      Nama resmi untuk sertifikat bahasa Inggris yang mungkin perlu Anda berikan
      adalah disebut SELT (Secure English Language Test). Jika salah satu dari
      berikut ini kondisinya benar, kamu<strong>JANGAN</strong> perlu memberikan
      SELT sebagai bagian dari aplikasi Anda.
    </Text>
    <StyledUL
      items={[
    ...
    />
    <Text>
      Anda juga tidak perlu membuktikan pengetahuan bahasa Inggris Anda jika
      Anda seorang warga negara dari salah satu negara berikut:
    </Text>
    <StyledUL
      items={[
        { text: 'Antigua and Barbuda' },
    ...
    />
    <Text>
      Jika Anda tidak memenuhi salah satu dari kondisi di atas, Anda perlu
      belajar untuk tes Anda, yang kami siapkan dan lulus (hore) adalah IELTS.{' '}
      <Link href='/posts/how-to-pass-ielts'>
        Temukan panduan belajar kami di sini
      </Link>
    </Text>
    <Text>
      Informasi lebih lanjut tentang CELT dan daftar pusat pengujian yang
      disetujui di negaramu{' '}
      <SimpleLink link='https://www.gov.uk/guidance/prove-your-english-language-abilities-with-a-secure-english-language-test-selt'>
    ...
    <Text>
      Inilah putaran cepat mengenai dokumen umum yang harus Anda kumpulkan untuk
      mendukung aplikasi Anda.
    </Text>
    <StyledUL
      items={[
    ...
    <Text>
      Ambang batas untuk memenuhi persyaratan keuangan UKVI adalah gaji tahunan
      setidaknya £18.600. Namun, jika Anda tidak memenuhi persyaratan ini dan
      memiliki penghematan yang cukup besar, £60,000+, selama Anda bisa
      membuktikannya tabungan dapat diakses oleh Anda, Anda harus baik.
    </Text>
    <Text>
      Dokumen yang harus Anda kumpulkan untuk membuktikan keuangan Anda dan yang
      Anda miliki izin untuk tinggal di mana pun Anda mengatakan Anda akan
      tinggal di visa Anda aplikasi.
    </Text>
    <StyledUL
      items={[
        {
    ...
    />
    <Text>
      Fiuh! Itu banyak bukan! Untuk dukungan yang dipersonalisasi dalam
      mengumpulkan dokumen saja, kami tidak dapat merekomendasikan i-vars,
      penasihat visa, cukup. Mereka adalah superstar dan menjawab semua 1.000
      pertanyaan yang kami miliki mereka. Sekarang yang tersisa hanyalah
      permainan menunggu. Biasanya, visa akan mengambil kurang dari 3 bulan
      untuk diproses, namun dengan pandemi ada sedikit backlog dan bisa memakan
      waktu hingga 4 bulan atau lebih. Itu{' '}
      <SimpleLink link='https://www.gov.uk/guidance/visa-decision-waiting-times-applications-outside-the-uk?msclkid=81bf9ef8d12311ec9cea32779cb8b0d4#join-family-in-the-uk'>
        status waktu tunggu saat ini dapat dilihat di sini
      </SimpleLink>
    </Text>
    <Text>
      Sekitar satu bulan setelah kami mengirimkan aplikasi kami, kami menerima
      email mengatakan aplikasi telah mencapai pusat pengambilan keputusan
      Inggris. Mereka memberikan kesempatan terakhir bagi kami untuk memberikan
      dokumen pendukung melalui VSFGlobal atau dengan langsung mengirimkan
      dokumen ke alamat di Birmingham Inggris. Meskipun mereka dikenakan biaya £
      100 untuk mengirim dokumen. Ini meyakinkan untuk ketahuilah bahwa jika
      Anda lupa mengirimkan dokumen tertentu pada saat Anda aplikasi, ini bukan
      kesempatan terakhir Anda untuk memberikan UKVI semua yang mereka butuhkan
      untuk membuat aplikasi Anda berhasil.
    </Text>
    <Heading size='md'>Durasi Visa</Heading>
    <Text>
      Dengan visa keluarga Inggris, Anda awalnya dapat tinggal di Inggris selama
      2 tahun dan 9 bulan. Setelah ini, Anda dapat mengajukan permohonan untuk
      memperpanjang masa tinggal Anda untuk yang lain 2 tahun 6 bulan. Setelah
      Anda tinggal di Inggris selama 5 tahun terus menerus dengan visa keluarga,
      Anda dapat mengajukan permohonan untuk menetap di Inggris (disebut cuti
      tidak terbatas untuk tetap atau dengan kata yang lebih sederhana, permanen
      tempat tinggal).
    </Text>
    <Text>
      Semua yang terbaik dari keberuntungan untuk Anda dan kami berharap Anda
      dan pasangan Anda hidup bahagia bersama{' '}
    </Text>
  </BlogLayout>
);
