...
const IndonesianBlog = (
  ...
  >
    ...
    <Text>
      ...
      <Center>
        <Image src={`${imagePath}hotel2Rooms.webp`} alt='Gade Village rooms' />
      </Center>
  ...
  return (
    ...
    >
      ...
      <Text>
        ...
        a large hotel with some outstanding views, friendly staff and a huge
      ...
      <Heading>Hotel 2</Heading>
      <Text>
        Now all of those activities we've talked about so far happen in the
        heart of Jogja, however, if you venture outside the city by an hour or
        so, there's so much history and beauty to be witnessed. Now if there's
        one the thing we love more than travel, it's sleep, so in order to make
        it to the famous sunrise spot "Punthuk Setumbu", we'd have to be a
        little closer to it than our hotel near Malioboro.{' '}
      ...
      <Text>
        ...
        temples. We were torn between two, with it being our final day in Jogja
        we could only choose one, Borobudur or the Prambanan Temple... well as
        we're talking about Borobudur you can guess which we chose. Borobudur
        Temple is magnificent, the biggest Buddhist temple built. For Indonesian
      ...
      <Text>
        We love re-living and sharing these experiences, we hope you can get a
        bit of an insight into this fascinating place in Indonesia. Safe travels
        to all!
      </Text>
    </BlogLayout>
  );
