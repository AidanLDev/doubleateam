...
export default function UsingAstro() {
  ...
  return (
    ...
    >
      ...
      <Text>
        There really isn't much involved to get your site hosted up on Netlify
        for the world to see, just a couple of steps:
        <StyledUL
          items={[
            {
              text: (
      ...
      <Text>
        On the next screen select the repo that stores the code of the website
        you want to host.
      </Text>
      <Text>
        ...
        random pile of letters and numbers. Under <b>Custom Domains</b> click
        the <code>options</code> and click <code>Edit site name</code>. Now you
        can't completely modify the site name here as it will always have a
        suffix of <code>.netlify.app</code>. However, you can make it something
        memorable and relevant to your site which is nice as it saves you from
        having to go out and buy your own domain name, which can be pretty pricy
        especially if you want a good name with a .com Top Level Domain (TLD).
        However, if you do already have a domain, you can hook this up to your
        newly hosted website too.
      </Text>
      ...
      <Text>
        ...
        <SimpleLink link="https://www.heroku.com/">Heroku</SimpleLink>. Heroku
        is a good option if your website has an API or other Backend
        infrastructure as you can deploy code to web servers such as{" "}
        <code>Node</code>. However, the free tier puts the site on a server that
        has a cold start-up so your site will take a long time to load. This is
        why for static sites I would highly recommend using Netlify, it's simple
        and does the job!
      </Text>
    </BlogLayout>
  );
