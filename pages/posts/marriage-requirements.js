...
export default function HowToPassIelts() {
  ...
  return (
    ...
    >
      ...
      <Text>
        If you’re a British citizen this will ask you a short series of
        questions to point you to the embassy you need to contact to get the
      ...
      <Text>
        ...
        KUAs and will require the following:
      </Text>
      <StyledUL
        items={[
      ...
      <Text>
        The only two documents I needed translating was my birth certificate and
        passport. Luckily for us the British embassy printed out the Affidavit
        in both English and Indonesian so that didn’t need translating, if you
        don’t have the Affidavit/ affirmation in Indonesian you’ll have to get
        that translated too.
      </Text>
      <Heading size='md'>
      ...
      <Text>
        ...
        Kacematans. Kelurahan are a subdivison below kacematans, so they’re
        fourth-level subdivision which an translate to “villages” in English.
        ...
        confusing, Indonesia is just such a huge country it can take a lot to
        get our heads around how it’s divided up and organised if you haven’t
        lived there.
      </Text>
      <Text>
