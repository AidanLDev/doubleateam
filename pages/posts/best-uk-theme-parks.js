  ...
  return (
    ...
    >
      <Text>
        ...
        coasters scattered between various parks. Let's dive deep into what
        parks are here in the UK.
      </Text>
      ...
      >
        <Text>
          ...
          also some of the most beautiful scenery surrounding an old stately
          home.
        </Text>
        <Text>
      ...
      >
        <Text>
          The Island like no other... Located in Staines, not too far from
          London, this park packs a punch. It's compact full of record breaking
          thrill rides such as the UK's fastest roller coaster Stealth.
        </Text>
        <Text>
          Thorpe park as some incredibly well themes rides, such as the
          terrefying Walking Dead ride where you'll be chased by live actors, to
          Swarm, a fantastic wing coaster, where you fly past a crashed plane
          and through a billboard. SAW the ride branded as the first horror
          coaster will have you screaming as you rocket down a beyond vertical
          drop dodging sharp blades as you plumbit down.
        </Text>
      </ThemeparkBox>
      ...
      >
        <Text>
          ...
          The log flume, Tiger Rock, has you float past a Tiger encolsure on
          your journey through the water before you hit the big drop that is.
        </Text>
        <Text>
          There's plenty for the children here, with Gruffalo and Room on a
          Broom just being a couple of them. The areas are well themed,
          especially the Mexicana area which had a welcome lick of paint
          recently, where you can ride the Scorpion Express, formally knwon as
          the Runaway Train.
        </Text>
        <Text>
          The Vampire is a must ride, a well themed suspended coaster that has
          you flying above the park and Dragons Fury, the Maurer spinning
          coaster, never fails to put the biggest smile on my face. A unique
          ride every time as the spinning is completely random.
        </Text>
        <Text>
      ...
      >
        <Text>
          ...
          first driving test at the age of 4 or so. Plenty to do here as a
          family.
        </Text>
        <Text>
        ...
        <Text>
          Miniland is a must visit while you're here, you can see some of the
          most famous attractions built in Lego with fantastic attention to
          detail.{" "}
        </Text>
      </ThemeparkBox>
      ...
      >
        <Text>
          I always feel like I'm going back in time when I step foot here, in
          the nicest way possible that is. They do have wooden coasters that
          have been around since the 1920s after all. The park has such a fun
          atmosphere and you get a great view of the sea too as it's right on
          the coast.
        </Text>
        <Text>
          There's many unique attractions here, such as Revolution, a launch
          into a loop... then you get launched backwards back through the loop!
          It's surprisingly intense and a LOT of fun. Avalanche, a bobsled
          coaster and just so much more.
        </Text>
        <Text>
          The Icon is regarded as the best in the UK by many thrill seakers,
          this double launch coaster is such a blast every time I ride it.
          Talking of coasters, you can't forget the BIG ONE, still the tallest
          in the UK, a title it's held since 1994 (the best year). Although
          Thorpe Park might have there eyes on that record (if planning
          permissions ever get accepted).
        </Text>
      </ThemeparkBox>
      ...
      >
        <Text>
          Paultons, home of Pepper Pig land, a family friendly theme park that
          has plenty to keep a thrill seaker entertained. The park has a
          relaxing atomosphere with beautiful gardens and animals.
        </Text>
        <Text>
      ...
      >
        <Text>
          ...
          Flamingos... although it does have a Zoo, this "Theme park resort"
          also offers some thrills from rides such as Flip Flop and Cliff
          Hanger. In fact the Zoo is well maintained and attracts more visitors
          than the ZSL London Zoo which is impressive.
        </Text>
        <Text>
          The park offers plenty of attractions for children too with the likes
          of Mumbo Jumbo and Vortex.
        </Text>
        <Text>
      ...
      >
        <Text>
          ...
          hosts the UKs only standing roller coaster, Shockwave, which is just
          an experiance that feels incredibly odd, a must try experiance.
        </Text>
        <Text>
          ...
          seakers will enjoy Shockwave and on a sunny day Stormforce 10 is sure
          to cool you down.
        </Text>
        <Text>
          Overall this park has improved in recent years, the theming of it's
          new Viking land has a lot of attention to detail. I mean just look at
      ...
      >
        <Text>
          ...
          highly rated wooden coaster. There's a good variety of rides across
          the park, the other thrill coaster Speed is a lot of fun too. There
          are a couple of family friendly coasters too so the whole family can
          enjoy a day out in Oakwood.
        </Text>
        <Text>
          The park is green and spacious in the beautiful Welsh countryside. Not
          a bad small park, worth a visit if you're in the area. Especially if
          you want to ride a great woddie.
        </Text>
      </ThemeparkBox>
    </BlogLayout>
  );
