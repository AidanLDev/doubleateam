...
const EnglishBlog = (
  ...
  >
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}thorpe-park/stealth.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}/chessington/crock-drop-img.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}legoland-windsor.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}/blackpool/icon.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}paultons.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}adventure-island.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}flamingoland.avif`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}drayton-manor.avif`}
    >
      <Text>
