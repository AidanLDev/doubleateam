...
const EnglishBlog = (
  ...
  >
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}staffordshire-countryside.jpg`}
    >
      <Text>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}octonoughts.jpg`}
    ></ThemeparkBox>
    <ThemeparkBox
      park='Runaway Mine Train'
      imageSrc={`${imgPath}runaway-mine-train.jpg`}
    ></ThemeparkBox>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}enterprise.jpg`}
    ></ThemeparkBox>
    ...
    <Text>
      ...
      <SmallBlogImg src={`${imgPath}stately-home.jpg`} alt='stately home' />
    </Text>
    <Text>
