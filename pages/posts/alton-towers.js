...
const EnglishBlog = (
  ...
  >
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}staffordshire-countryside.avif`}
    >
      <Text>
    ...
    <Text>
      ...
      park and a discount on food/drink/merch from inside the park.
    </Text>
    <Text>
    ...
    />
    <Text>
      On top of that, you will get a discount or free entry to the following UK
      attractions:
    </Text>
    <StyledUL
      items={[
    ...
    >
      <Text>
        ...
        are just a spectacular experience. A coaster everyone needs to add to
        their bucket list. Surprisingly comfortable too!
      </Text>
    </ThemeparkBox>
    <ThemeparkBox
      park='Nemesis'
      imageSrc={`${imgPath}nemesis.avif`}
    ...
    >
      <Text>
        ...
        pass over this giant alien creator a few times. This coaster is properly
        intense, so if that's your thing be sure to give it a ride
      </Text>
    </ThemeparkBox>
    <ThemeparkBox
      park='Oblivion'
      imageSrc={`${imgPath}oblivion.avif`}
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}octonoughts.avif`}
    ></ThemeparkBox>
    <ThemeparkBox
      park='Runaway Mine Train'
      imageSrc={`${imgPath}runaway-mine-train.avif`}
    ></ThemeparkBox>
    ...
    <ThemeparkBox
      ...
      imageSrc={`${imgPath}enterprise.avif`}
    ></ThemeparkBox>
    ...
    <Text>
      ...
      Talbot family since 1406 when Sir John Talbot acquired the estate when he
      ...
      attractions. However, when the earl and his wife separated in 1896, he
      left his wife to live on the estate, although he refused to spend money on
      the up-keep of the building. A group of local businessmen bought the
      estate and formed "Alton Towers Limited". By the 1920s they opened the
      grounds up to the public and added cafes, it was extremely popular during
      the 20s and 30s. When world war 2 broke out, the estate was re-purposed as
      a cadet training camp.
      <SmallBlogImg src={`${imgPath}stately-home.avif`} alt='stately home' />
    </Text>
    <Text>
      ...
      floors were added to the house so visitors could enter and walk around. By
    ...
    <Text>
      ...
      by audio describing some of the histories of the park as well as a
    ...
    <Text>
      ...
      <SmallBlogImg src={`${imgPath}waterfall-still.avif`} alt='Waterfall' />
    </Text>
    <Heading>Gallery</Heading>
    <SmallBlogImg src={`${imgPath}me-and-bob.avif`} alt='Me and big b' />
    <Text>
      <Center>
        <AspectRatio w='500px' ratio={1}>
          <video
