        ...
        <VStack>
          <Card>
            <Box>
              ...
              <span> - Send an email to our double a team mailbox</span>
            </Box>
            <Box>
              <Link
              ...
              <span> - Be sure to visit our YouTube channel!</span>
            </Box>
            <Divider margin='12px 0' />
            <Center>
              <Heading>Arni's Socials</Heading>
            </Center>
            <Center>
              <Image
                alt='Arnis photo'
            ...
            <Box>
              ...
              <span>
                {' '}
                - Not much of a tweeter, but worth a follow in-case she finds
                her voice
              </span>
            </Box>
            <Divider margin='12px 0' />
            <Center>
              <Heading>Aidan's Socials</Heading>
            </Center>
            <Center>
              <Image
                alt='Aidans photo'
            ...
            <Box>
              ...
              <span>
                {' '}
                - Not quite as good a photographer as Arni, however we try to
                keep IG relatively up to date so give us a follow 😉
              </span>
            </Box>
            <Box>
              <Link
                href='https://twitter.com/AidanL94'
                passHref
                target='_blank'
                rel='noopener noreferrer'
              >
              ...
              <span>
                {' '}
                - Again... much of a tweeter, but you never know if that will
                change?!
              </span>
            </Box>
            <Box>
